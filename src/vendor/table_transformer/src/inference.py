...
from vendor.table_transformer.src.main import get_model
import vendor.table_transformer.src.postprocess
sys.path.append("../detr")
from vendor.table_transformer.detr.models import build_model
